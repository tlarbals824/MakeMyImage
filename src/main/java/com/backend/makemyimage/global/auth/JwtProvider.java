package com.backend.makemyimage.global.auth;



import com.backend.makemyimage.global.exception.BusinessException;
...
import static com.backend.makemyimage.global.exception.errorDto.ErrorCode.*;

//jwt는 그냥 가져옴, 원래 jwt도 다 직접 구현하나???
@Getter
@Component
public class JwtProvider {
    ...
    public void validateAccessToken(String accessToken) {
        try {
            ...
            throw new BusinessException(EXPIRED_ACCESS_TOKEN);
        } catch (Exception e) {
            throw new BusinessException(INVALID_ACCESS_TOKEN_VALUE);
        }
    }
    ...
    public void validateRefreshToken(String refreshToken) {
        try {
            ...
            throw new BusinessException(INVALID_REFRESH_TOKEN_VALUE);
        }
    }
    ...
    public void equalsRefreshToken(String providedRefreshToken, String storedRefreshToken) {
        if (!providedRefreshToken.equals(storedRefreshToken)) {
            throw new BusinessException(NOT_MATCH_REFRESH_TOKEN);
        }
    }
